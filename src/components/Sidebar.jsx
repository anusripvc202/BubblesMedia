  ...
  return (
    <aside style={{ background: 'var(--bg-white)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)', overflow: 'hidden', height: 'fit-content', boxShadow: 'var(--shadow-sm)' }}>
      ...
      <div style={{ background: 'var(--secondary)', color: 'white', padding: '14px 20px', display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <span style={{ fontSize: '0.8rem', fontWeight: '800', letterSpacing: '0.5px', textTransform: 'uppercase', fontFamily: 'var(--font-display)' }}>
          Browse Categories
        </span>
      </div>
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flex: 1 }}>
                <div style={{ color: isActive ? 'var(--primary)' : 'var(--text-medium)', background: isActive ? 'rgba(255,90,0,0.06)' : '#F8FAFC', width: '32px', height: '32px', borderRadius: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  {cat.icon}
                </div>
              ...
              <div style={{ color: isActive ? 'var(--primary)' : 'var(--text-light)', marginLeft: '8px', display: 'flex', alignItems: 'center', opacity: isActive ? 1 : 0.6 }}>
