    ...
    <header style={{ width: '100%', background: 'var(--bg-white)', borderBottom: '1px solid var(--border-color)', zIndex: 100, position: 'sticky', top: 0 }}>
      ...
      <div className="container-layout" style={{ padding: '8px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
          ...
          {/* Right Controls - Moved here for mobile */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            {/* Account */}
            <div className="hide-on-mobile" style={{ display: 'flex', alignItems: 'center', gap: '10px', borderLeft: '1px solid var(--border-color)', paddingLeft: '16px' }}>
              <div style={{ background: 'var(--primary-light)', color: 'var(--primary)', width: '36px', height: '36px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                👤
              </div>
              <div>
        ...
        <div style={{ display: 'flex', gap: '12px', width: '100%', flexWrap: 'wrap' }}>
          ...
          <form onSubmit={handleSearchSubmit} style={{ flex: 1, minWidth: '200px', display: 'flex', background: 'white', borderRadius: '6px', overflow: 'hidden', border: '1px solid var(--border-color)' }}>
            <input
              type="text"
