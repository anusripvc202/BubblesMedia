  ...
  return (
    <section style={{ marginBottom: '40px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <div>
          <h2 style={{ fontSize: '1.4rem', fontWeight: '800' }}>Solutions for Every Industry</h2>
          <p style={{ fontSize: '0.8rem', color: 'var(--text-light)', marginTop: '2px' }}>Custom-tailored digital blueprints built specifically for your business domain</p>
        </div>
      ...
      <div style={{
        ...
        {industries.map((ind, idx) => (
          ...
          >
            ...
            <span style={{ fontSize: '0.75rem', fontWeight: '700', color: 'var(--text-dark)', lineHeight: '1.2' }}>
              {ind.name}
            </span>
          </button>
        ))}
